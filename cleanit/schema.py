...
def array(schema: dict[str, Any], min_items: int = 0) -> dict[str, Any]:
...
def one_or_array(schema: dict[str, Any]) -> dict[str, Any]:
...
class AliasesSchema:
    schema = {"type": "object", "patternProperties": {".+": {"type": "string"}}, "minProperties": 1}


class ExampleSchema:
    schema = one_of(
        array({"type": "string"}, min_items=1),
        {"type": "object", "patternProperties": {".+": {"type": ["string", "null"]}}, "minProperties": 1},
    )
...
class RulesSchema:
    schema = {"type": "object", "patternProperties": {".+": RuleSchema.schema}, "minProperties": 1}
